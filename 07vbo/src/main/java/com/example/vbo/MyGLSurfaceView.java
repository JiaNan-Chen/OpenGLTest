...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    private int mVertexVBO, mColorVBO;
    ...
    public MyGLSurfaceView(Context context, AttributeSet attrs) {
        ...
        mColorBuffer = ByteBuffer.allocateDirect(3 * 4 * 4).order(ByteOrder.nativeOrder()).asFloatBuffer().put(mColor);
        ...
        setRenderer(new Renderer() {
            ...
            public void onSurfaceCreated(GL10 gl, EGLConfig config) {
                ...
                GLES20.glBufferData(GLES20.GL_ARRAY_BUFFER, 3 * 2 * 4, mVertexBuffer, GLES20.GL_STATIC_DRAW);

                mColorVBO = buffer[1];
                GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, mColorVBO);
                GLES20.glBufferData(GLES20.GL_ARRAY_BUFFER, 3 * 4 * 4, mColorBuffer, GLES20.GL_STATIC_DRAW);
            }
